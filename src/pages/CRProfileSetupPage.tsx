...
const CR_OPTIONS = ['CR-1', 'CR-2'];

const CRProfileSetupPage = () => {
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-md mx-auto px-6 pt-5 pb-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm font-medium text-foreground">CR Profile</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <input {...register('rollNumber')} readOnly className="w-full rounded-[14px] border-0 bg-secondary h-[54px] px-5 text-[13px] text-muted-foreground focus:outline-none" />
          </div>
          ...
          <div>
            ...
            <input {...register('department')} readOnly className="w-full rounded-[14px] border-0 bg-secondary h-[54px] px-5 text-[13px] text-muted-foreground focus:outline-none" />
          </div>
...
export default CRProfileSetupPage;
