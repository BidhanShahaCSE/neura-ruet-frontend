        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              ...
              className="px-5 py-2 bg-white/5 border border-white/10 text-white font-semibold text-sm rounded-full hover:bg-white/10 hover:border-neon/30 hover:shadow-neon transition-all duration-300"
            >
              Web Login
            </button>
            <a
          ...
          <div className="md:hidden flex items-center gap-3">
            <button
              onClick={() => navigate('/login')}
              className="px-3 py-1.5 bg-white/10 border border-white/10 text-white font-semibold text-xs rounded-full"
            >
              Login
            </button>
            <a
