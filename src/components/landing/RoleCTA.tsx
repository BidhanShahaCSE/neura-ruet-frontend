        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              ...
              <div className="text-left">
                <span className="text-[10px] text-gray-400 block leading-none">Access on the</span>
                <span className="text-sm font-semibold text-white group-hover:text-neon transition-colors">Web Version</span>
              </div>
            </motion.button>
          </div>
        </motion.div>
