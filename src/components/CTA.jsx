            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 leading-tight">
                        ...
                        <span className="block">university experience?</span>
                    </h2>
                    <p className="text-gray-400 text-base sm:text-lg max-w-xl mx-auto mb-10 leading-relaxed">
                        Download NeuraRUET today and let AI handle the heavy lifting.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        >
                            <HiDownload className="text-xl text-neon" />
                            <div className="text-left">
                                <span className="text-[10px] text-gray-400 block leading-none">Download for</span>
                                <span className="text-sm font-semibold text-white group-hover:text-neon transition-colors">Android APK</span>
                            </div>
                        </motion.a>
                        ...
                        <motion.a
                            ...
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="inline-flex items-center gap-3 px-6 py-3.5 bg-neon text-dark rounded-full hover:bg-neon-dark hover:shadow-neon-md transition-all duration-300 group"
                        >
                            <FaApple className="text-xl" />
                            <div className="text-left">
                                <span className="text-[10px] text-dark/70 block leading-none">Download on the</span>
